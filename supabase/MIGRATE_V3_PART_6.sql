-- LOTE 6 V3: NOTÍCIAS (Artigos 41 a 50)
...
A narrativa oficial de ambos os lados é de acusação mútua, enquanto o terreno mostra que o conflito é estrutural e resistente a acordos pontuais, indicando que qualquer trégua terá de ser acompanhada de fiscalização real e comprometimento militar concreto.', 'Política', 'https://s.rfi.fr/media/display/7ac5757a-6a80-11ed-9491-005056bfb2b6/w:1280/p:16x9/REUTERS%20-%20James%20Akena.png', 'Redacção', true, true, true, 7160, '2026-02-25T01:18:22.933063+00:00', '2026-03-24T08:30:00.184503+00:00') ON CONFLICT DO NOTHING;
...
provar, com actos — não discursos — que a lei é igual para todos.', 'Sociedade', 'https://www.vozdeangola.com/media/k2/items/cache/bd29c45aa603ee6a2c9d275e0264c267_M.jpg', 'Redacção', false, false, true, 1417, '2026-03-18T17:36:16.065234+00:00', '2026-03-24T08:30:00.184503+00:00') ON CONFLICT DO NOTHING;
...
Sem Filtros (fecho opinativo):
No Irão, o poder raramente muda de rumo — muda apenas de mãos. A irritação de Washington revela mais frustração estratégica do que surpresa política. O verdadeiro problema não é quem lidera em Teerão, mas o facto de o confronto entre as duas potências continuar preso a um ciclo de desconfiança que mantém o Médio Oriente permanentemente à beira da explosão.', 'Mundo', 'https://cdn.folhape.com.br/upload/dn_arquivo/2026/03/afp-20260303-99nn9g4-v2-midres-topshotusiranisraelwartrump.jpg', 'Redacção', false, true, true, 3879, '2026-03-09T19:25:50.730123+00:00', '2026-03-24T08:30:00.184503+00:00') ON CONFLICT DO NOTHING;
...
', 'Saúde', 'https://www.verangola.net/va/images/cache/750x380/crop/images%7Ccms-image-000057275.jpg', 'Redacção', false, true, true, 5173, '2026-03-04T15:06:26.117451+00:00', '2026-03-24T08:30:00.184503+00:00') ON CONFLICT DO NOTHING;
...
Sem Filtros (fecho opinativo):
A Champions não vive apenas de nomes grandes, vive de noites imprevisíveis. Quando clubes históricos e equipas emergentes se encontram no mesmo palco, a lógica muitas vezes fica no balneário. E é exactamente por isso que estas noites europeias continuam a ser o verdadeiro espectáculo do futebol mundial. ⚽', 'Desporto', 'https://pstzibmplwiatkuanhhn.supabase.co/storage/v1/object/public/news/5n7v8gqsvju_1773124740397.webp', 'Redacção', false, false, true, 3753, '2026-03-10T06:39:22.883477+00:00', '2026-03-24T08:30:00.184503+00:00') ON CONFLICT DO NOTHING;
